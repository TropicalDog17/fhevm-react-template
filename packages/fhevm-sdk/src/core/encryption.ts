...
// Create and encrypt inputs using the RelayerEncryptedInput builder
export const createEncryptedInputAndEncrypt = async (
  ...
  buildFn(input);
  const enc = (await input.encrypt()) as EncryptResult;
  return enc;
};
